  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-secondary-50">
      <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full text-center border border-secondary-200">
        <h1 className="text-3xl font-bold text-secondary-900 mb-2">GrantKit</h1>
        <p className="text-secondary-600 mb-8">Professional grant proposal management</p>

        <button
          onClick={handleGoogleSignIn}
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white border border-secondary-300 rounded-lg font-medium text-secondary-700 hover:bg-secondary-50 transition-colors disabled:opacity-50"
        >
